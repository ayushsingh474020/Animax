...
import Profile from '../src/pages/Profile.jsx';
import Upload from '../src/components/Upload.jsx';
import DisplayAnimes from '../src/pages/DisplayAnimes.jsx';
import { BrowserRouter, Routes, Route } from 'react-router-dom'
import { useDispatch, useSelector } from "react-redux";
import styled from 'styled-components';
import AudioPlayer from "./components/AudioPlayer.jsx";
...
const Animax = styled.div`
  display: flex;
  flex-direction: row-reverse; /* Change to row-reverse to move menu to the right */
  width: 100%;
  height: 100vh;
  background: ${({ theme }) => theme.bgLight};
  overflow-y: hidden;
        ...
        <Animax>
          ...
          <Frame>
            ...
            <Routes>
              ...
              <Route path='/showanimes/:type' exact element={<DisplayAnimes/>} />
            </Routes>
          </Frame>
