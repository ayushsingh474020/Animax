...
const AudioPlayer = ({ episode, podid, currenttime, index }) => {
    ...
    const goToNextAnime = () => {
        //from the podid and index, get the next anime
        //dispatch the next anime
    ...
    return (
        <Container>
            ...
            <Player>
                <Controls>
                    <IcoButton>
                        <SkipPreviousRounded onClick={() => goToPreviousAnime()} />
                    </IcoButton>
                    <Audio
                        ref={audioRef}
                        onTimeUpdate={handleTimeUpdate}
                        onEnded={() => goToNextAnime()}
                        autoPlay
                        controls
                    ...
                    />
                    <IcoButton>
                        <SkipNextRounded onClick={() => goToNextAnime()} />
                    </IcoButton>
                </Controls>
            </Player>
            <Sound>
